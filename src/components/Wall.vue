<template>
    <a-plane v-bind:rotation='rotation' v-bind:position='position' height='10' width='10' src='#brick'>
        ...
        <a-circle v-on:click='toggle' zOffset='.001' position='0 -4.2 .001' radius='.5'>
            <a-text align='center' value='More' color='black'></a-text>
        </a-circle>
        <a-plane v-if='toggled' color='gray' opacity='.85' position='0 -3.2 3.4' height='.75' width='1.5'>
